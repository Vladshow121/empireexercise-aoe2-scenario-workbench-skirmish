...
Каталог локальных учебных сценариев экономики и составов войск.
...
- **Local economy exercises** — запланированный модуль; реализации нет.
- **Army matchup worksheets** — запланированный модуль; реализации нет.
- **Scenario version notes** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Local economy exercises**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Age of Empires II: Definitive Edition, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Army matchup worksheets

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Age of Empires II: Definitive Edition, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Scenario version notes

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Age of Empires II: Definitive Edition, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Age of Empires II: Definitive Edition |
...
| Планируемый результат | Local economy exercises |
