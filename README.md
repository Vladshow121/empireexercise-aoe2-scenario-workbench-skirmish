...
<div align="center">
  <img src="./public/logo.svg" alt="EmpireExercise — Age of Empires II: Definitive Edition — Skirmish" width="64" height="64">
  <h1>EmpireExercise — Age of Empires II: Definitive Edition — Skirmish</h1>
</div>

An independent project specification for Age of Empires II: Definitive Edition, covering local economy exercises, army matchup worksheets, scenario version notes.
...
<img src="./public/screenshots/desktop-main.svg" alt="Age of Empires II: Definitive Edition — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Age of Empires II: Definitive Edition — compact concept, not a screenshot" width="250">
<br>
...
- **Local economy exercises** — planned module; not implemented.
- **Army matchup worksheets** — planned module; not implemented.
- **Scenario version notes** — planned module; not implemented.

The proposed workflow separates local economy exercises from army matchup worksheets, with scenario version notes retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Local economy exercises**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="EmpireExercise — Age of Empires II: Definitive Edition — Skirmish — specification review workflow">
<br>
...
### Local economy exercises

Define the input and expected outcome for module 1. Record the Age of Empires II: Definitive Edition version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Army matchup worksheets

Define the input and expected outcome for module 2. Record the Age of Empires II: Definitive Edition version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Scenario version notes

Define the input and expected outcome for module 3. Record the Age of Empires II: Definitive Edition version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Age of Empires II: Definitive Edition |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Local economy exercises |
